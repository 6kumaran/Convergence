  ...
  return (
    <div className="relative h-auto bg-black text-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-7" style={{ fontFamily: 'Nasalization, sans-serif' }}>
      ...
      <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
        <h1 className="text-6xl md:text-4xl  text-orange-600">Questival</h1>
      </div>
...
<br /><br /><span className='pl-3'>The next challenge will emphasize endurance (specifics to be finalized), allowing the team to construct the middle layer of 3 cups, adding stability to their tower.</span>
