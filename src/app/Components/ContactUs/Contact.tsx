  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-slate-600 sm:text-4xl">
                For More Details
            </p>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                ...
                <div className="flex">
                    ...
                    <div className="ml-4">
                        ...
                        <dd className="mt-2 text-base text-gray-500">
                            6th Nov: 10am to 4pm<br/>
                            7th Nov: 10am to 4pm<br/>
                        </dd>
                    </div>
                </div>
            </dl>
